...
public class AllApiResponse {
    ...
    public class AdverResp {
        ...
        public class AdverDataModel {
            ...
            public String getFeatField10() {
                return featField10;
            }

            public void setFeatField10(String featField10) {
                this.featField10 = featField10;
            }
    ...
    public class GetAllFavAds{
        ...
        @SerializedName("data")
        @Expose
        private List<FavAdsItem> data = null;
        ...
        public List<FavAdsItem> getData() {
            return data;
        }

        public void setData(List<FavAdsItem> data) {
            this.data = data;
        }

        public class FavAdsItem{
